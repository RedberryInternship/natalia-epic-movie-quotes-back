<html>
   ...
   <body style="background: #181624; color:white;font-family: 'Montserrat', sans-serif; word-wrap: break-word;">
       <div style="display: flex; flex-direction:column; gap: 2px;   justify-content: center; padding:3% 10% ">
           ...
           <p style="margin-bottom: 32px">Thanks for joining Movie quotes! We really appreciate it. Please click the button below to reset your password:</p>
           <a href="{{ $url }}"
               style=" padding:7px 10px; text-align:center; max-width: 128px; color:white;background:#E31221;text-decoration: none;font-weight: 400; border-radius:5px">Reset Password</a>
